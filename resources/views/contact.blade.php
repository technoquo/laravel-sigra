<x-app-layout>
<div class="container pb-8 md:pb-12 lg:pb-20 max-w-7xl">
    ...
    <div class="contact-links-container flex flex-col md:flex-row justify-center w-full">
        <div class="md:w-1/3 mb-4 md:mb-0">
            <img class="rounded-lg w-full" src="storage/form-attachments/team.jpeg" alt="team">
        </div>
        
        <div class="md:w-1/4">
            <div class="bg-sigra flex justify-center p-1 md:p-10 lg:p-5  md:w-52  -ml-3 md:-ml-6 mt-7">
